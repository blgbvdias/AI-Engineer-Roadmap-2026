...
def build_knowledge_base():
    ...
    documents = [
        ...
        "The secret WiFi password in the London office is 'Baguette2026'.",
...
def main():
    ...
    user_query = "What is the WiFi password for the London office?"
    ...
    """
    messages = [
        {"role": "system", "content": "You are a helpful corporate AI assistant."},
